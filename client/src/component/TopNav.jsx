  ...
  return (
    <div className='max-w-[1520] mx-auto flex justify-between items-center p-4'>
        <div className='flex items-center'>
          ...
          <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2'>Food<span className='font-bold'>Point</span></h1>
        ...
        <button className='bg-orange-700 text-white hidden md:flex items-center py-2 rounded-ful'>
        ...
        <div className= {sideNav ? 'fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-200'
                ...
                <h2 className='text-2xl p-4'>Food<span className='text-orange-700 font-bold'>Point</span></h2>
                <nav>
